...
text \<open>This section corresponds to Section 2.2.4 and Figure 3.4 of the thesis.\<close>
...
lemma pure_mult1:
  ...
  using assms entails_def pure_def by fastforce
