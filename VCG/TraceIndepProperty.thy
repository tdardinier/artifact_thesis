...
next
  ...
  proof (cases rule: th_result_rel.cases)
    ...
    next
      case False
      hence "\<omega>' = update_mh_loc_total_full \<omega> (the_address r, f) (PosReal.padd (get_mh_total_full \<omega> (the_address r, f)) (Abs_preal p))"
      ...
      let ?\<omega>2' = "update_mh_loc_total_full \<omega>2 (the_address r, f) (PosReal.padd (get_mh_total_full \<omega>2 (the_address r, f)) (Abs_preal p))"
...
next
  ...
  proof (cases rule: th_result_rel.cases)
    ...
    next
      case False
      from this obtain q
        where "\<omega>' = update_mh_loc_total_full \<omega> (the_address r, f) (PosReal.padd (get_mh_total_full \<omega> (the_address r, f)) q)"
      ...
      let ?\<omega>2' = "update_mh_loc_total_full \<omega>2 (the_address r, f) (PosReal.padd (get_mh_total_full \<omega>2 (the_address r, f)) q)"
