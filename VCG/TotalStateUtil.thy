...
imports "../CoreIVL/SepAlgebra" TotalViperUtil TotalViperState "../Viper/DeBruijn"
begin
...
proof
  ...
  proof
    ...
    from this obtain p where "m l = PosReal.padd (m' l) p"
    ...
    thus "m l = PosReal.padd (m' l) (m l \<ominus> m' l)"
...
next
  ...
  proof
    ...
    thus "get_mh_total \<omega> hl = PosReal.padd (get_mh_total \<omega>' hl) (get_mh_total \<omega> hl - get_mh_total \<omega>' hl)"
  ...
  proof
    ...
    thus "get_mp_total \<omega> hl = PosReal.padd (get_mp_total \<omega>' hl) (get_mp_total \<omega> hl - get_mp_total \<omega>' hl)"
      by (simp add:Rep_preal_inject[symmetric] minus_preal.rep_eq plus_preal.rep_eq)
  qed  
...
proof -
  ...
  proof
    fix l
    have "m0 l = PosReal.padd (m1 l) (m2 l)"
