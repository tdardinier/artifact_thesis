theory SepAlgebraDef
  imports Main PosReal (* PosRat  PosPerm *)
begin
...
lemma sumI:
  assumes "a ## b"
      and "\<And>y. Some y = a \<oplus> b \<Longrightarrow> x = y"
...
section \<open>PCM: Adding positivity\<close>
class pcm = pre_pcm +
  assumes positivity: "a \<oplus> b = Some c \<Longrightarrow> Some c = c \<oplus> c \<Longrightarrow> Some a = a \<oplus> a"
begin
...
text \<open>Axioms from the thesis\<close>
